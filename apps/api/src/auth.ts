...
const DEMO_USERS: Record<string, AuthContext> = {
  'demo-superadmin': {
...
export function createRequireAuth(supabaseAdmin: SupabaseClient | null) {
...
export function updateDemoUser(userId: string, updates: Partial<Pick<AuthContext, 'fullName' | 'email'>>): void {
